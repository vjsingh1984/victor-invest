...
class ComprehensiveLLMStrategy(ILLMStrategy):
    ...
    def _prepare_synthesis_request(self, symbol: str, data: Dict[str, Any], model: str, request_id: str) -> LLMRequest:
        ...
        return LLMRequest(
            ...
            request_id=request_id,
            timestamp=datetime.utcnow(),
            metadata={"task_type": LLMTaskType.SYNTHESIS.value, "symbol": symbol, "strategy": self.get_strategy_name()},
        )
...
class QuickLLMStrategy(ILLMStrategy):
    ...
    def prepare_request(self, task_type: LLMTaskType, data: Dict[str, Any]) -> LLMRequest:
        ...
        return LLMRequest(
            ...
            request_id=request_id,
            timestamp=datetime.utcnow(),
            metadata={"task_type": task_type.value, "symbol": symbol, "strategy": self.get_strategy_name()},
        )
