...
INDUSTRY_PROFILES: Dict[IndustryCategory, IndustryProfile] = {
    ...
    IndustryCategory.SOFTWARE_SAAS: IndustryProfile(
        ...
        dcf_weight=25, pe_weight=25, ps_weight=15, ev_ebitda_weight=25, pb_weight=5, ggm_weight=5,
        key_metrics=["revenue_growth", "rule_of_40", "net_retention", "cac_ltv", "gross_margin"],
        holding_period="3m", volatility="high", cyclical=False, orientation="growth"
    ),
    ...
    IndustryCategory.SOFTWARE_ENTERPRISE: IndustryProfile(
        ...
        dcf_weight=30, pe_weight=30, ps_weight=10, ev_ebitda_weight=20, pb_weight=5, ggm_weight=5,
        key_metrics=["revenue_growth", "operating_margin", "fcf_margin", "backlog"],
        holding_period="3m", volatility="medium", cyclical=False, orientation="growth"
    ),
    ...
    IndustryCategory.SEMICONDUCTORS: IndustryProfile(
        ...
        dcf_weight=15, pe_weight=30, ps_weight=5, ev_ebitda_weight=30, pb_weight=20, ggm_weight=0,
        key_metrics=["gross_margin", "inventory_days", "capex_intensity", "book_to_bill"],
        holding_period="3m", volatility="very_high", cyclical=True, orientation="blend"
    ),
    ...
    IndustryCategory.HARDWARE_CONSUMER: IndustryProfile(
        ...
        dcf_weight=35, pe_weight=25, ps_weight=15, ev_ebitda_weight=15, pb_weight=5, ggm_weight=5,
        key_metrics=["revenue_growth", "gross_margin", "inventory_turns", "services_revenue"],
        holding_period="1m", volatility="medium", cyclical=True, orientation="blend"
    ),
    IndustryCategory.CLOUD_INFRASTRUCTURE: IndustryProfile(
        ...
        dcf_weight=30, pe_weight=15, ps_weight=30, ev_ebitda_weight=20, pb_weight=0, ggm_weight=5,
        key_metrics=["revenue_growth", "gross_margin", "capex_intensity", "remaining_performance_obligations"],
        holding_period="1m", volatility="high", cyclical=False, orientation="growth"
    ),
    IndustryCategory.CYBERSECURITY: IndustryProfile(
        category=IndustryCategory.CYBERSECURITY,
        display_name="Cybersecurity",
        dcf_weight=25, pe_weight=10, ps_weight=40, ev_ebitda_weight=20, pb_weight=0, ggm_weight=5,
    ...
    IndustryCategory.PHARMA_LARGE: IndustryProfile(
        ...
        dcf_weight=35, pe_weight=25, ps_weight=10, ev_ebitda_weight=15, pb_weight=5, ggm_weight=10,
        key_metrics=["pipeline_value", "patent_cliff", "rd_intensity", "operating_margin"],
        holding_period="3m", volatility="medium", cyclical=False, orientation="blend"
    ),
    IndustryCategory.PHARMA_SPECIALTY: IndustryProfile(
        ...
        dcf_weight=30, pe_weight=20, ps_weight=25, ev_ebitda_weight=20, pb_weight=0, ggm_weight=5,
    ...
    IndustryCategory.BIOTECH_COMMERCIAL: IndustryProfile(
        ...
        dcf_weight=35, pe_weight=20, ps_weight=25, ev_ebitda_weight=15, pb_weight=0, ggm_weight=5,
    ...
    IndustryCategory.BIOTECH_CLINICAL: IndustryProfile(
        ...
        dcf_weight=20, pe_weight=0, ps_weight=60, ev_ebitda_weight=0, pb_weight=20, ggm_weight=0,
        key_metrics=["cash_runway", "pipeline_value", "clinical_trial_progress", "partnership_value"],
        holding_period="18m", volatility="very_high", cyclical=False, orientation="growth"
    ),
    IndustryCategory.MEDICAL_DEVICES: IndustryProfile(
        category=IndustryCategory.MEDICAL_DEVICES,
        display_name="Medical Devices",
        dcf_weight=35, pe_weight=25, ps_weight=15, ev_ebitda_weight=20, pb_weight=0, ggm_weight=5,
    ...
    IndustryCategory.BANK_MONEY_CENTER: IndustryProfile(
        ...
        dcf_weight=10, pe_weight=30, ps_weight=0, ev_ebitda_weight=5, pb_weight=45, ggm_weight=10,
        key_metrics=["nim", "efficiency_ratio", "tier1_capital", "rote", "npl_ratio"],
        holding_period="1m", volatility="medium", cyclical=True, orientation="value"
    ),
    ...
    IndustryCategory.BANK_REGIONAL: IndustryProfile(
        ...
        dcf_weight=10, pe_weight=25, ps_weight=0, ev_ebitda_weight=5, pb_weight=50, ggm_weight=10,
        key_metrics=["nim", "efficiency_ratio", "deposit_growth", "loan_growth", "npl_ratio"],
        holding_period="1m", volatility="high", cyclical=True, orientation="value"
    ),
    ...
    IndustryCategory.BANK_INVESTMENT: IndustryProfile(
        ...
        dcf_weight=15, pe_weight=30, ps_weight=0, ev_ebitda_weight=10, pb_weight=40, ggm_weight=5,
        key_metrics=["trading_revenue", "advisory_fees", "rote", "compensation_ratio", "var"],
        holding_period="3m", volatility="high", cyclical=True, orientation="blend"
    ),
    ...
    IndustryCategory.INSURANCE_LIFE: IndustryProfile(
        ...
        dcf_weight=20, pe_weight=20, ps_weight=0, ev_ebitda_weight=5, pb_weight=45, ggm_weight=10,
        key_metrics=["embedded_value", "new_business_margin", "roe", "solvency_ratio"],
        holding_period="1m", volatility="medium", cyclical=False, orientation="value"
    ),
    ...
    IndustryCategory.INSURANCE_PC: IndustryProfile(
        ...
        dcf_weight=15, pe_weight=20, ps_weight=0, ev_ebitda_weight=5, pb_weight=50, ggm_weight=10,
    ...
    IndustryCategory.ASSET_MANAGEMENT: IndustryProfile(
        ...
        dcf_weight=30, pe_weight=25, ps_weight=15, ev_ebitda_weight=20, pb_weight=5, ggm_weight=5,
        key_metrics=["aum_growth", "fee_rate", "flows", "operating_margin"],
        holding_period="1m", volatility="high", cyclical=True, orientation="blend"
    ),
    IndustryCategory.EXCHANGES: IndustryProfile(
        ...
        holding_period="3m", volatility="medium", cyclical=True, orientation="blend"
    ),
    IndustryCategory.CREDIT_SERVICES: IndustryProfile(
        ...
        holding_period="3m", volatility="medium", cyclical=True, orientation="growth"
    ),
    ...
    IndustryCategory.RETAIL_ECOMMERCE: IndustryProfile(
        ...
        holding_period="1m", volatility="high", cyclical=True, orientation="growth"
    ),
    IndustryCategory.RETAIL_SPECIALTY: IndustryProfile(
        category=IndustryCategory.RETAIL_SPECIALTY,
        display_name="Retail - Specialty",
        dcf_weight=30, pe_weight=25, ps_weight=15, ev_ebitda_weight=25, pb_weight=0, ggm_weight=5,
    ...
    IndustryCategory.RETAIL_DISCOUNT: IndustryProfile(
        ...
        dcf_weight=35, pe_weight=25, ps_weight=10, ev_ebitda_weight=20, pb_weight=5, ggm_weight=5,
        key_metrics=["same_store_sales", "inventory_turns", "membership_revenue", "ecommerce_penetration"],
        holding_period="3m", volatility="medium", cyclical=True, orientation="value"
    ),
    IndustryCategory.AUTO_OEM: IndustryProfile(
        category=IndustryCategory.AUTO_OEM,
        display_name="Automotive - Traditional OEM",
        dcf_weight=25, pe_weight=30, ps_weight=10, ev_ebitda_weight=25, pb_weight=10, ggm_weight=0,
        key_metrics=["unit_sales", "average_selling_price", "warranty_costs", "ev_mix"],
        holding_period="3m", volatility="high", cyclical=True, orientation="value"
    ),
    IndustryCategory.AUTO_EV: IndustryProfile(
        category=IndustryCategory.AUTO_EV,
        display_name="Automotive - EV Pure-Play",
        dcf_weight=25, pe_weight=10, ps_weight=40, ev_ebitda_weight=20, pb_weight=5, ggm_weight=0,
        key_metrics=["deliveries_growth", "gross_margin", "battery_cost", "regulatory_credits"],
        holding_period="3m", volatility="very_high", cyclical=True, orientation="growth"
    ),
    ...
    IndustryCategory.HOMEBUILDERS: IndustryProfile(
        ...
        dcf_weight=25, pe_weight=30, ps_weight=10, ev_ebitda_weight=20, pb_weight=15, ggm_weight=0,
    ...
    IndustryCategory.LUXURY_GOODS: IndustryProfile(
        ...
        dcf_weight=30, pe_weight=25, ps_weight=20, ev_ebitda_weight=20, pb_weight=0, ggm_weight=5,
    ...
    IndustryCategory.FOOD_BEVERAGE: IndustryProfile(
        ...
        dcf_weight=20, pe_weight=25, ps_weight=5, ev_ebitda_weight=15, pb_weight=15, ggm_weight=20,
        key_metrics=["organic_growth", "price_mix", "gross_margin", "market_share"],
        holding_period="1m", volatility="low", cyclical=False, orientation="value"
    ),
    ...
    IndustryCategory.TOBACCO: IndustryProfile(
        ...
        dcf_weight=15, pe_weight=20, ps_weight=0, ev_ebitda_weight=10, pb_weight=20, ggm_weight=35,
        key_metrics=["volume_decline", "pricing_power", "reduced_risk_products", "dividend_coverage"],
        holding_period="3m", volatility="low", cyclical=False, orientation="value"
    ),
    ...
    IndustryCategory.AEROSPACE_DEFENSE: IndustryProfile(
        ...
        dcf_weight=20, pe_weight=30, ps_weight=5, ev_ebitda_weight=25, pb_weight=15, ggm_weight=5,
        key_metrics=["backlog", "book_to_bill", "program_margins", "fcf_conversion"],
        holding_period="1m", volatility="medium", cyclical=False, orientation="blend"
    ),
    ...
    IndustryCategory.AIRLINES: IndustryProfile(
        ...
        dcf_weight=10, pe_weight=25, ps_weight=5, ev_ebitda_weight=40, pb_weight=20, ggm_weight=0,
        key_metrics=["rasm", "casm", "load_factor", "available_seat_miles", "fuel_hedge"],
        holding_period="1m", volatility="very_high", cyclical=True, orientation="value"
    ),
    ...
    IndustryCategory.INDUSTRIAL_CONGLOMERATES: IndustryProfile(
        ...
        dcf_weight=25, pe_weight=30, ps_weight=5, ev_ebitda_weight=20, pb_weight=15, ggm_weight=5,
    ...
    IndustryCategory.OIL_INTEGRATED: IndustryProfile(
        ...
        dcf_weight=30, pe_weight=20, ps_weight=5, ev_ebitda_weight=25, pb_weight=10, ggm_weight=10,
    ...
    IndustryCategory.OIL_EXPLORATION: IndustryProfile(
        ...
        dcf_weight=25, pe_weight=15, ps_weight=5, ev_ebitda_weight=35, pb_weight=15, ggm_weight=5,
        key_metrics=["production_growth", "reserve_life", "finding_costs", "breakeven_price"],
        holding_period="3m", volatility="very_high", cyclical=True, orientation="value"
    ),
    IndustryCategory.OIL_SERVICES: IndustryProfile(
        category=IndustryCategory.OIL_SERVICES,
        display_name="Oil & Gas Services",
        dcf_weight=25, pe_weight=20, ps_weight=15, ev_ebitda_weight=30, pb_weight=10, ggm_weight=0,
    ...
    IndustryCategory.RENEWABLE_ENERGY: IndustryProfile(
        ...
        dcf_weight=35, pe_weight=15, ps_weight=20, ev_ebitda_weight=25, pb_weight=0, ggm_weight=5,
        key_metrics=["capacity_additions", "ppa_prices", "capacity_factor", "development_pipeline"],
        holding_period="18m", volatility="high", cyclical=False, orientation="growth"
    ),
    ...
    IndustryCategory.UTILITIES_REGULATED: IndustryProfile(
        ...
        dcf_weight=15, pe_weight=20, ps_weight=0, ev_ebitda_weight=15, pb_weight=20, ggm_weight=30,
    ...
    IndustryCategory.UTILITIES_INDEPENDENT: IndustryProfile(
        ...
        dcf_weight=25, pe_weight=25, ps_weight=5, ev_ebitda_weight=20, pb_weight=15, ggm_weight=10,
    ...
    IndustryCategory.CHEMICALS_SPECIALTY: IndustryProfile(
        ...
        dcf_weight=35, pe_weight=25, ps_weight=10, ev_ebitda_weight=25, pb_weight=0, ggm_weight=5,
    ...
    IndustryCategory.CHEMICALS_COMMODITY: IndustryProfile(
        ...
        dcf_weight=25, pe_weight=20, ps_weight=10, ev_ebitda_weight=30, pb_weight=10, ggm_weight=5,
    ...
    IndustryCategory.MINING_DIVERSIFIED: IndustryProfile(
        ...
        dcf_weight=25, pe_weight=20, ps_weight=5, ev_ebitda_weight=30, pb_weight=15, ggm_weight=5,
    ...
    IndustryCategory.STEEL: IndustryProfile(
        ...
        display_name="Steel",
        dcf_weight=20, pe_weight=20, ps_weight=5, ev_ebitda_weight=35, pb_weight=15, ggm_weight=5,
    ...
    IndustryCategory.REIT_RESIDENTIAL: IndustryProfile(
        ...
        dcf_weight=15, pe_weight=20, ps_weight=0, ev_ebitda_weight=15, pb_weight=25, ggm_weight=25,
    ...
    IndustryCategory.REIT_INDUSTRIAL: IndustryProfile(
        ...
        dcf_weight=20, pe_weight=20, ps_weight=0, ev_ebitda_weight=15, pb_weight=20, ggm_weight=25,
        key_metrics=["ffo", "same_store_noi", "occupancy", "rent_spreads", "development_pipeline"],
        holding_period="1m", volatility="medium", cyclical=True, orientation="growth"
    ),
    ...
    IndustryCategory.REIT_DATA_CENTER: IndustryProfile(
        ...
        holding_period="1m", volatility="medium", cyclical=False, orientation="growth"
    ),
    ...
    IndustryCategory.REIT_CELL_TOWER: IndustryProfile(
        ...
        dcf_weight=25, pe_weight=20, ps_weight=5, ev_ebitda_weight=15, pb_weight=15, ggm_weight=20,
        key_metrics=["affo", "tenant_billings", "colocation", "escalators", "churn"],
        holding_period="1m", volatility="low", cyclical=False, orientation="growth"
    ),
    ...
    IndustryCategory.TELECOM_WIRELESS: IndustryProfile(
        ...
        dcf_weight=20, pe_weight=20, ps_weight=0, ev_ebitda_weight=15, pb_weight=15, ggm_weight=30,
    ...
    IndustryCategory.ADVERTISING: IndustryProfile(
        ...
        dcf_weight=30, pe_weight=35, ps_weight=5, ev_ebitda_weight=20, pb_weight=5, ggm_weight=5,
        key_metrics=["revenue_growth", "arpu", "dau_mau", "ad_pricing", "engagement"],
        holding_period="3m", volatility="high", cyclical=True, orientation="growth"
    ),
    ...
    IndustryCategory.GAMING: IndustryProfile(
        ...
        dcf_weight=25, pe_weight=35, ps_weight=10, ev_ebitda_weight=20, pb_weight=5, ggm_weight=5,
    ...
    IndustryCategory.UNKNOWN: IndustryProfile(
        ...
        dcf_weight=20, pe_weight=30, ps_weight=5, ev_ebitda_weight=15, pb_weight=20, ggm_weight=10,
