        ...
        if exact_matches:
            ...
            if context.target_fiscal_period:
                fp_matches = [
                    ...
                    if self._matches_fiscal_period_by_duration(e, context.target_fiscal_period)
                ]
                if fp_matches:
                    logger.debug(
