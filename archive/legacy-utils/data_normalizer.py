...
class DataNormalizer:
    ...
    # Debt metrics for enhanced completeness scoring
    DEBT_METRICS = ["totalDebt", "longTermDebt", "shortTermDebt", "currentLiabilities"]
    ...
    def assess_completeness(cls, data: Dict[str, Any], include_debt_metrics: bool = True) -> Dict[str, Any]:
        ...
        Args:
            data: Financial data dictionary (should be in camelCase format)
        ...
        """
        # Normalize to camelCase for consistent checking
        normalized_data = cls.normalize_field_names(data, to_camel_case=True)
        ...
        for metric in cls.CORE_METRICS:
            value = normalized_data.get(metric)
