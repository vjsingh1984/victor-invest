...
python3 -m investigator.infrastructure.database.installer --sqlite investigator.db
...
python3 -m victor_invest.cli analyze AAPL --mode comprehensive --output results/

# Batch analysis
python3 -m victor_invest.cli batch AAPL MSFT GOOGL --mode standard --output-dir results/

# Peer group comparison
python3 -m victor_invest.cli compare AAPL MSFT GOOGL --output comparison.json

# Force cache refresh (bypass all caches)
python3 -m victor_invest.cli analyze TSLA --mode standard --force-refresh
----
...
----
# Clean all caches
python3 -m victor_invest.cli clean-cache --all

# Clean cache for specific symbol
python3 -m victor_invest.cli clean-cache --symbol AAPL

# Clean database cache only
python3 -m victor_invest.cli clean-cache --db

# Clean disk cache only
python3 -m victor_invest.cli clean-cache --disk

# Inspect cache contents
python3 -m victor_invest.cli inspect-cache --symbol AAPL --verbose

# Show cache sizes by type
python3 -m victor_invest.cli cache-sizes
----
...
[source,bash]
----
python3 -m victor_invest.cli analyze AAPL --mode comprehensive --force-refresh
...
. Check Ollama status: `python3 -m victor_invest.cli status`
...
. Inspect cache: `python3 -m victor_invest.cli inspect-cache --symbol AAPL --verbose`
