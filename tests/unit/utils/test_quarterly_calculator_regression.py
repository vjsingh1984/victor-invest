...
import pytest
from utils.quarterly_calculator import get_rolling_ttm_periods, compute_missing_quarter
...
class TestIssue2YTDConversionRegression:
    ...
    def test_q4_computation_allowed_with_missing_q1_q2_ytd_q3(self):
        ...
        q4_result = compute_missing_quarter(
            fy_data=fy_data,
            q1_data=None,  # Missing
            q2_data=None,  # Missing
            q3_data=q3_ytd_data  # YTD
        )
    ...
    def test_q4_computation_still_skipped_when_q2_ytd_with_missing_q1(self):
        ...
        q4_result = compute_missing_quarter(
            fy_data=fy_data,
            q1_data=None,  # Missing
            q2_data=q2_ytd_data,  # YTD
            q3_data=q3_data  # Individual
        )
